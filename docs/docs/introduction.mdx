...
export const title = "HTML To Gutenberg - Convert HTML to Gutenberg blocks";
    ...
    <div class="container">
      <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 md:col-span-6">
          <h2 class="text-2xl" data-bind="section_title">I am editable – awesome, right?</h2>
...
| InspectorControls           | :white_check_mark: |
